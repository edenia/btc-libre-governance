...
CONTRACT btclgovernan : public contract
{
  public:
     ...
     */
    ACTION setparams( name    funding_account,
  ...
  private:
    ...
    TABLE proposals
    {
        ...
        uint64_t by_created_on() const
        {
            return created_on.sec_since_epoch();
        }
        uint64_t by_expires_on() const
        {
            return expires_on.sec_since_epoch();
        }
    };
    typedef multi_index<
        name( "proposals" ),
